...
exports.reset = exports.forgot = exports.updateUser = exports.signup = exports.logout = exports.login = void 0;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "sign up success!");
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            url = type === "user" ? "/users/me" : "/users/password";
            _context4.next = 4;
            return (0, _axios.default)({
              method: "patch",
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "user data changed!");
...
var reset = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "password changed");
              location.assign("/");
            }
  ...
  return function reset(_x10, _x11) {
...
exports.createMap = exports.displayMap = exports.deleteTour = exports.updateTour = exports.createTour = void 0;
...
var updateTour = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === "success") (0, _alert.showAlert)("success", "tour updated successfully!");
            window.history.back();
            _context2.next = 11;
            break;
  ...
  return function updateTour(_x2) {
    return _ref2.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "delete",
              url: "/tours/".concat(tourId)
            });

          case 3:
            res = _context3.sent;
            if (res.status === 204) (0, _alert.showAlert)("success", "tour deleted successfully!");
            window.history.back();
            _context3.next = 11;
            break;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiOTA5amltaW4iLCJhIjoiY2s5bm93ZjRhMDQyZjNlbXNjamhmMG50ZyJ9.-CBrcxVrXHK3F44amvfj9A";
  ...
  locations.forEach(function (loc) {
    ...
    var popup = new mapboxgl.Popup({
      offset: 15
    }).setHTML("<h3>Day-".concat(loc.day, "</h3><h4>").concat(loc.name, "</h4><p>").concat(loc.description, "</p>"));
    new mapboxgl.Marker({
      element: el,
      anchor: "bottom"
...
var createMap = function createMap() {
  ...
  map.on("click", function (e) {
    var coord = [e.lngLat.wrap().lng, e.lngLat.wrap().lat]; //
    ...
    var table = document.querySelector(".place-table");
    table.insertAdjacentHTML("beforeend", "<tr><td class='day'><input class='locationDay' type='text' value=".concat(i, "></td><td><input class='location' type='text'/></td><td><input class='locationInfo' type='text'/></td></tr>"));
    i++;
    var locationEl = document.querySelectorAll(".location");
...
exports.deleteBooking = exports.createBooking = void 0;
...
var stripe = Stripe("pk_test_PYDZp5HEYwoxmuIklFO0HulV00sQQls0cW");

var createBooking = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId, userName) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "get",
              url: "/bookings/checkout-session/".concat(tourId, "/").concat(userName)
            });
...
var deleteBooking = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(bookingId) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "delete",
              url: "/bookings/".concat(bookingId)
            });

          case 3:
            res = _context2.sent;
            if (res.data.status === "success") (0, _alert.showAlert)("success", "booking deleted!");
            window.history.back();
            _context2.next = 11;
            break;
  ...
  return function deleteBooking(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourRating, tourReview, guideRating, guideReview, tourId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            if (res.data.status === "success") (0, _alert.showAlert)("success", "review success!");
            window.history.back();
            _context.next = 11;
            break;
  ...
  return function createReview(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateDataForm = document.querySelector(".form--updateData");
...
var resetPassword = document.querySelector(".form--resetPassword"); //tour

var tourForm = document.querySelector(".form--createTour");
var updateTourForm = document.querySelector(".form--updateTour");
var deleteTourBtn = document.querySelectorAll(".deleteTour");
var mapBox = document.getElementById("map");
var createMapBox = document.getElementById("createMap"); //review

var createReviewForm = document.querySelector(".form--createReview"); //booking

var bookingBtn = document.getElementById("booking");
var deleteBookingBtn = document.querySelectorAll(".deleteBooking");
...
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    (0, _user.signup)(name, email, password, passwordConfirm);
  });
}
...
if (loginForm) {
  loginForm.addEventListener("submit", function (e) {
    ...
    var email = document.getElementById("email").value;
    var password = document.getElementById("password").value;
    (0, _user.login)(email, password);
  });
}

if (logoutBtn) logoutBtn.addEventListener("click", _user.logout);
...
if (resetPassword) {
  resetPassword.addEventListener("submit", function (e) {
    ...
    var password = document.getElementById("password").value;
    var passwordConfirm = document.getElementById("passwordConfirm").value;
    (0, _user.reset)(password, passwordConfirm);
  });
}
...
if (tourForm) {
  tourForm.addEventListener("submit", function (e) {
    ...
    var coordinateArr = [];
    var descriptionArr = [];
    document.querySelectorAll(".locationDay").forEach(function (el) {
      return dayArr.push(el.value);
    });
    document.querySelectorAll(".location").forEach(function (el) {
      return nameArr.push(el.value);
    });
    document.querySelectorAll(".locationInfo").forEach(function (el) {
      return descriptionArr.push(el.value);
    });
    document.querySelectorAll(".location").forEach(function (el) {
      return coordinateArr.push(el.dataset.lngLat);
    });
    var locations = [];
...
if (bookingBtn) bookingBtn.addEventListener("click", function (e) {
  ...
  (0, _booking.createBooking)(tourId, userName);
});
if (deleteBookingBtn) deleteBookingBtn.forEach(function (el) {
  return el.addEventListener("click", function (e) {
    e.preventDefault();
    var bookingId = e.target.dataset.bookingId;
    (0, _booking.deleteBooking)(bookingId);
  });
});
if (createReviewForm) createReviewForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var tourRating = document.getElementById("tourRating").value;
  var tourReview = document.getElementById("tourReview").value;
  var guideRating = document.getElementById("guideRating").value;
  var guideReview = document.getElementById("guideReview").value;
  var tourId = document.getElementById("reviewCreateBtn").dataset.tourId;
  (0, _review.createReview)(tourRating, tourReview, guideRating, guideReview, tourId);
});
if (deleteTourBtn) deleteTourBtn.forEach(function (el) {
  return el.addEventListener("click", function (e) {
    e.preventDefault();
    var tourId = e.target.dataset.tourId;
...
if (mapBox) {
  ...
  (0, _tour.displayMap)(locations);
}

if (createMapBox) {
  (0, _tour.createMap)();
}
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime/runtime.js":"../../node_modules/regenerator-runtime/runtime.js","./user.js":"user.js","./tour.js":"tour.js","./booking.js":"booking.js","./review.js":"review.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "61142" + '/');
